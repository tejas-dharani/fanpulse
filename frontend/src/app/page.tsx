...
const TEAMS = [
  { loyalty: "RCB" as Loyalty, label: "Royal Challengers Bengaluru", color: "text-red-400", bg: "bg-red-900/30", border: "border-red-600 hover:border-red-400", emoji: "🔴" },
  { loyalty: "DC" as Loyalty, label: "Delhi Capitals", color: "text-blue-400", bg: "bg-blue-900/30", border: "border-blue-600 hover:border-blue-400", emoji: "🔵" },
  { loyalty: "NEUTRAL" as Loyalty, label: "Just here for the cricket", color: "text-gray-400", bg: "bg-gray-800/30", border: "border-gray-600 hover:border-gray-400", emoji: "⚪" },
];
